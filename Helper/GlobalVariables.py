...
btnBFS = Button(0, 240, 150, 45, WHITE, BLACK, "Breadth First Search")
btnBestFS = Button(0, 285, 150, 45, WHITE, BLACK, "Best First Search")
dropWalls = Button(0, 330, 150, 45, WHITE, BLACK, "Walls")
dropExtraNodes= Button(0, 375, 150, 45, WHITE, BLACK, "Extra Nodes")
btnVisualise = Button(0, 420, 150, 45, WHITE, GREEN, "Visualise")
btnClearBoard = Button(0, 465, 150, 45, WHITE, BLACK, "Clear Board")
btnClearWall = Button(0, 510, 150, 45, WHITE, BLACK, "Clear Walls")
btnClearPath = Button(0, 555, 150, 45, WHITE, BLACK, "Clear Path")
dropSpeed = Button(0, 600, 150, 45, WHITE, BLACK, "Speed: ")
btnHelp = Button(0, 645, 150, 45, WHITE, BLACK, "Help")

...
def RecursiveDivision(grid, startRow, endRow, startCol, endCol):
...
def DivideHorizontally(grid, startRow, endRow, startCol, endCol):
    ...
    RecursiveDivision(grid, startRow, wallRow - 1, startCol, endCol)
    RecursiveDivision(grid, wallRow + 1, endRow, startCol, endCol)
...
def DivideVertically(grid, startRow, endRow, startCol, endCol):
    ...
    RecursiveDivision(grid, startRow, endRow, startCol, wallCol - 1)
    RecursiveDivision(grid, startRow, endRow, wallCol + 1, endCol)